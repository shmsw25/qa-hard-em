...
def generate_wikisql_bert(path_wikisql, dset_type):
    path_q = os.path.join(path_wikisql, '{dset_type}.jsonl')
    path_tbl = os.path.join(path_wikisql, '{dset_type}.tables.jsonl')
    ...
    # Save
    with open(os.path.join(path_wikisql, '{dset_type}_bert.json'), 'w', encoding='utf-8') as fnew:
